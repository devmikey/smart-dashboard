          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="success" stats icon>
                ...
                <h3 className={classes.cardTitle}>3/3</h3>
              </CardHeader>
              <CardFooter stats>
                <div className={classes.stats}>
                  <DateRange />
        ...
        <Grid container>
          <GridItem xs={12} sm={12} md={4}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Development Checks</h4>
              ...
              <CardFooter chart>
                <div className={classes.stats}>
                  <AccessTime /> Last check 2 weeks ago
                </div>
              </CardFooter>
            </Card>
          </GridItem>
